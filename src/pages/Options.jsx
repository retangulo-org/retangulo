      ...
      <div className="flex flex-col justify-center items-center">
        <div className="w-full divide-foreground dark:divide-neutral-800 divide-y-2">
          ...
          <div className="w-full py-2 flex flex-col ">
            ...
            <h6>
              Altera o tipo de teclado virtual: normal (teclado padrão) ou numérico. Alguns teclados numéricos não
              possuem o sinal de menos (-), isso impossibilita responder com números negativos.
            </h6>
          </div>
        </div>
