...
export default function Input({ onChange, value, placeholder, autoFocus, span }) {
  return (
    <div className="flex flex-col w-full">
      <h3 className="py-2 text-black dark:text-white text-base font-bold select-none">{span}</h3>
